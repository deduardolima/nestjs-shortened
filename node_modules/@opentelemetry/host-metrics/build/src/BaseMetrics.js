...
class BaseMetrics {
    constructor(config) {
        var _a;
        this._logger = api_1.diag;
        // Do not use `??` operator to allow falling back to default when the
        // specified name is an empty string.
        this._name = (config === null || config === void 0 ? void 0 : config.name) || DEFAULT_NAME;
        if ((config === null || config === void 0 ? void 0 : config.meterProvider) == null) {
            this._logger.warn('No meter provider, using default');
        }
        const meterProvider = (_a = config === null || config === void 0 ? void 0 : config.meterProvider) !== null && _a !== void 0 ? _a : api_1.metrics.getMeterProvider();
